...
Start from the nozzle presets — they map 0.2 / 0.4 / 0.6 / 0.8mm nozzles to matched layer height, line width, shell, band rhythm, and stitch size, plus the print-settings card for delivery:
